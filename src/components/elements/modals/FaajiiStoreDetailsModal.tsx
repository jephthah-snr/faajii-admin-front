...
interface FaajiiStoreDetailsModalProps {
  id: string;
  opened: boolean;
  onClose: () => void;
  onUpdateInventory: (item: Store) => void;
        ...
        <Flex mih="100vh" direction="column" justify="space-between">
          ...
          >
            <Button
              ...
              onClick={() =>
                storeDetails?.item && onUpdateInventory(storeDetails.item)
              }
              disabled={!storeDetails?.item}
            >
              Update Inventory
            </Button>
            <Button
...
export default FaajiiStoreDetailsModal;
